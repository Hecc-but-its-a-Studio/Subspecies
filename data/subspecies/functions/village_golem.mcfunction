...
effect give @e[tag=beefy_golem,limit=1,sort=nearest] minecraft:health_boost 35 3 true
...
effect give @e[tag=beefy_golem,limit=1,sort=nearest] minecraft:strength 35 0 true
effect give @e[tag=beefy_golem,limit=1,sort=nearest] minecraft:resistance 35 0 true
